...
Os arquivos gerados (e screenshots de erro, se houver) sobem como artefatos de cada execução, além de irem direto para a pasta de destino no Drive (sem subpasta por data) — se já existir um arquivo com o mesmo nome lá, ele é substituído em vez de duplicado.
